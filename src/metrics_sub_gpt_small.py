...
if __name__ == '__main__':
    ...
    ori_img_folder = '/net/csr-dgx1-04/data2/peixixio/exp-results/experiments/GPT_images_small_self_GPT4'
    new_img_folders = '/net/csr-dgx1-04/data2/peixixio/exp-results/experiments/GPT_images_small_self_GPT4'
    ...
    for ref_img_folder in glob.glob(os.path.join(ref_img_folders, '*')):
        ...
        with open(sub_cate + '_gpt4_self_small_result.json', 'w', encoding='utf-8') as f:
