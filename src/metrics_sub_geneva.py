...
def relink_img(ori_img_folder, new_img_folder, ref_img_folder):
    ...
    for ref_sub_folder in tqdm(glob.glob(ref_img_folder + '/*_gt')):
        ...
        # print('ref_sub_folder', ref_sub_folder)
        gen_name = str(int(sub_name.replace('_gt', ''))).zfill(6) + '/0.png'  # 0000
...
if __name__ == '__main__':
    ori_img_folder = '/home/peixixio/GeNeVA-ori/logs/iclevr_subtract/results_tmp' #'/home/peixixio/U-ViT/assets/results' # '/home/peixixio/dalle/out_coco' #'/home/peixixio/LatteGAN/results/out_clevr_new_dalle' #'/home/peixixio/LatteGAN/results/out_codraw_dalle' #'/home/peixixio/LatteGAN/results/out_img_dalle' #'/home/peixixio/LatteGAN/results/uvit_codraw' #'/home/peixixio/LatteGAN/results/out_images_uvit'
    new_img_folders = '/home/peixixio/LatteGAN/results/experiments/geneva_lrt2i' #'/home/peixixio/LatteGAN/results/experiments/uvit_lrt2i' # '/home/peixixio/LatteGAN/results/experiments/dalle_lrt2i' # '/home/peixixio/LatteGAN/results/experiments/dalle_iclevr_new' #'/home/peixixio/LatteGAN/results/experiments/dalle_codraw' #'/home/peixixio/LatteGAN/results/experiments/dalle_iclevr' #'/home/peixixio/LatteGAN/results/experiments/uvit_codraw' #'/home/peixixio/LatteGAN/results/experiments/uvit'
    ...
    for ref_img_folder in glob.glob(os.path.join(ref_img_folders, '*')):
        ...
        with open(sub_cate + '_geneva_lrt2i_result.json', 'w', encoding='utf-8') as f:
