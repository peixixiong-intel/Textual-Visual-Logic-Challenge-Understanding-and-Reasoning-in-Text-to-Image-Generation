...
def relink_img(ori_img_folder, new_img_folder, ref_img_folder):
    ...
    for ref_sub_folder in tqdm(glob.glob(ref_img_folder + '/*_gt')):
        ...
        os.symlink(ref_sub_folder, dst_folder)
        new_sub_folder = os.path.join(new_img_folder, sub_name.replace('_gt', ''))
        os.makedirs(new_sub_folder)
        old_gen_image = os.path.join(ori_img_folder, str(int(sub_name.replace('_gt', '')))+'.png')
        if os.path.exists(old_gen_image):
            os.symlink(old_gen_image, os.path.join(new_sub_folder, '0.png'))
        else:
            # COCO_val2014_000000000009.png
            old_gen_image = os.path.join(ori_img_folder, 'COCO_val2014_' + str(int(sub_name.replace('_gt', ''))).zfill(12) + '.png')
            os.symlink(old_gen_image, os.path.join(new_sub_folder, '0.png'))



if __name__ == '__main__':
    ori_img_folder = '/home/peixixio/LatteGAN/results/out_clevr_new_uvit' #'/home/peixixio/LatteGAN/results/out_clevr_new_dalle' #'/home/peixixio/LatteGAN/results/out_codraw_dalle' #'/home/peixixio/LatteGAN/results/out_img_dalle' #'/home/peixixio/LatteGAN/results/uvit_codraw' #'/home/peixixio/LatteGAN/results/out_images_uvit'
    new_img_folder = '/home/peixixio/LatteGAN/results/experiments/uvit_iclevr_new' # '/home/peixixio/LatteGAN/results/experiments/dalle_iclevr_new' #'/home/peixixio/LatteGAN/results/experiments/dalle_codraw' #'/home/peixixio/LatteGAN/results/experiments/dalle_iclevr' #'/home/peixixio/LatteGAN/results/experiments/uvit_codraw' #'/home/peixixio/LatteGAN/results/experiments/uvit'
    ref_img_folder = '/home/peixixio/LatteGAN/results/experiments/exp183-geneva-iclevr-few-shot/images_test' #'/home/peixixio/LatteGAN/results/experiments/exp169-geneva-codraw/images_test' #'/home/peixixio/LatteGAN/results/experiments/exp170-geneva-iclevr/images_test'
    ...
    ap, ar, f1, _, rsim, cmat = \
        calculate_inception_objects_accuracy(
            ...
            dataset_path="/home/peixixio/LatteGAN/data/iCLEVR-few-shot/clevr_test.h5",#'/home/peixixio/LatteGAN/data/CoDraw/codraw_test.h5', #"/home/peixixio/LatteGAN/data/iCLEVR/clevr_test.h5",
            batch_size=64,
            num_workers=32,
        )
    ...
    with open('uvit_clevr_new_result.json', 'w', encoding='utf-8') as f:
