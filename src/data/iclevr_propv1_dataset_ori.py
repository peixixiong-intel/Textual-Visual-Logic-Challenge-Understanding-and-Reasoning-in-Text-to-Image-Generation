...
class ICLEVRPropV1EvalDataset:
    ...
    def __getitem__(self, idx):
        ...
        # ToDo
        # print('turns_text_embedding', turns_text_embedding)
        # if "turns_text_neg_embedding" in example2:
        #     neg_n = example2["turns_text_neg_length"].shape[1]
        #     print('neg_n', neg_n)
        #     random_idx = np.random.randint(neg_n, size=1)[0]
        #     print('random_idx', random_idx)
        #
        #     print('turns_text_neg_embedding', example2["turns_text_neg_embedding"][...].shape)
        #     print('turns_word_neg_embeddings', example2["turns_word_neg_embeddings"][...].shape)
        #     print('turns_text_neg_length', example2["turns_text_neg_length"][...].shape)
        #     exit()
        #     turns_text_neg_embedding = \
        #         example2["turns_text_neg_embedding"][...][random_idx]  # (L, D)
        #     turns_word_neg_embeddings = \
        #         example2["turns_word_neg_embeddings"][...][random_idx]  # (L, S, D)
        #     turns_text_neg_length = \
        #         example2["turns_text_neg_length"][...][random_idx]  # (L,)
