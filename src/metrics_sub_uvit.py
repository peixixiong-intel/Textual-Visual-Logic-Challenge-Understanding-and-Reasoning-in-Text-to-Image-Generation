        ...
        with h5py.File(dataset_path, "r") as f:
            ...
            if category == 'general_all':
                ...
                for k in _keys:
                    ...
                    gen_name = str(int(scene_id))  + '.png'  # 0000
...
def relink_img(ori_img_folder, new_img_folder, ref_img_folder):
    ...
    for ref_sub_folder in tqdm(glob.glob(ref_img_folder + '/*_gt')):
        ...
        gen_name = str(int(sub_name.replace('_gt', ''))) + '.png'  # 0000
        old_gen_image = os.path.join(ori_img_folder, gen_name)
        # print('old_gen_image', old_gen_image)
        files_with_substring = glob.glob(old_gen_image)
        if bool(files_with_substring):
...
if __name__ == '__main__':
    ori_img_folder = '/home/peixixio/U-ViT/assets/results' #'/home/peixixio/U-ViT/assets/results' # '/home/peixixio/dalle/out_coco' #'/home/peixixio/LatteGAN/results/out_clevr_new_dalle' #'/home/peixixio/LatteGAN/results/out_codraw_dalle' #'/home/peixixio/LatteGAN/results/out_img_dalle' #'/home/peixixio/LatteGAN/results/uvit_codraw' #'/home/peixixio/LatteGAN/results/out_images_uvit'
    new_img_folders = '/home/peixixio/LatteGAN/results/experiments/uvit_lrt2i' #'/home/peixixio/LatteGAN/results/experiments/uvit_lrt2i' # '/home/peixixio/LatteGAN/results/experiments/dalle_lrt2i' # '/home/peixixio/LatteGAN/results/experiments/dalle_iclevr_new' #'/home/peixixio/LatteGAN/results/experiments/dalle_codraw' #'/home/peixixio/LatteGAN/results/experiments/dalle_iclevr' #'/home/peixixio/LatteGAN/results/experiments/uvit_codraw' #'/home/peixixio/LatteGAN/results/experiments/uvit'
